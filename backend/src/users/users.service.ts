...
const LOCATIONS: Location[] = [
  // Sports locations
  {
    ...
    longitude: 12.9714,
    description:
      'Modern sports facility at the university campus with basketball courts and gym',
    qrCode: 'SPORTS_001_QR',
    imageUrl:
      'https://www.mittweida.de/fileadmin/_processed_/e/9/csm_dreifeldhalle_dfda6cfc82.jpg',
  },
  {
    id: 'sports_002',
    ...
    longitude: 12.9743,
    description:
      'Scenic jogging and cycling path along the Zschopauer Mulde river',
    qrCode: 'SPORTS_002_QR',
    imageUrl:
      'https://cloudfront-eu-central-1.images.arcpublishing.com/madsack/TZVTUFJET5PSCBQXPE4NYXFASM.jpg',
  },
  {
    id: 'sports_003',
    ...
    longitude: 12.9681,
    description:
      'Local football stadium where FSV Mittweida plays their home games',
    qrCode: 'SPORTS_003_QR',
    imageUrl:
      'https://www.mittweida.de/fileadmin/Sport/stadion3.jpg',
  },
  // Nightlife locations
  {
    id: 'nightlife_001',
    ...
    longitude: 12.9701,
    description:
      'Popular student club near the university with live music and parties',
    qrCode: 'NIGHTLIFE_001_QR',
    imageUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Mittweida-Studentenclub.jpg/1200px-Mittweida-Studentenclub.jpg',
  },
  {
    id: 'nightlife_002',
    ...
    longitude: 12.9732,
    description:
      'Cozy bar in the town center, perfect for evening drinks and conversations',
    qrCode: 'NIGHTLIFE_002_QR',
    imageUrl:
      'https://img.restaurantguru.com/c47f-Irish-Pub-Mittweida-bar-counter.jpg',
  },
  {
    id: 'nightlife_003',
    ...
    imageUrl:
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/08/ba/d5/4e/ratskeller-waldheim.jpg?w=900&h=500&s=1',
  },
  // Culture locations
  {
    id: 'culture_001',
    ...
    longitude: 12.9739,
    description:
      'Historic castle showcasing local history and medieval artifacts',
    qrCode: 'CULTURE_001_QR',
    imageUrl:
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/52/b8/aa/schloss-neusorge.jpg?w=500&h=500&s=1',
  },
  {
    id: 'culture_002',
    ...
    longitude: 12.9721,
    description:
      "Beautiful medieval church in the heart of Mittweida's old town",
    qrCode: 'CULTURE_002_QR',
    imageUrl:
      'https://www.pfarrei-edithstein.de/wp-content/uploads/2020/05/kirche-mittweida-aussen.jpg',
  },
  {
    id: 'culture_003',
    ...
    longitude: 12.9708,
    description:
      'Contemporary art gallery featuring student and local artist exhibitions',
    qrCode: 'CULTURE_003_QR',
    imageUrl:
      'https://www.ausland.hs-mittweida.de/fileadmin/_processed_/6/8/csm__KUR3925-Bearbeitet_fadac53a69.jpg',
  },
];
...
export class UsersService {
  ...
  private readonly userLocationsPath = path.join(
    process.cwd(),
    'src',
    'data',
    'user-locations.json',
  );
  private readonly friendsPath = path.join(
    process.cwd(),
    'src',
    'data',
    'friends.json',
  ...
  getRandomLocation(
    ...
    const availableLocations = categoryLocations.filter(
      (loc) => !completedLocationIds.includes(loc.id),
    );
  ...
  scanQRCode(
    ...
    const userLocations = this.readUserLocations();
    const alreadyCompleted = userLocations.some(
      (ul) => ul.userId === userId && ul.locationId === location.id,
    );
    ...
    const userCompletedCount = userLocations.filter(
      (ul) => ul.userId === userId,
    ).length;
  ...
  getUserProgress(userId: string): {
    ...
    return {
      ...
      percentage: Math.round(
        (userCompletedLocationIds.length / LOCATIONS.length) * 100,
      ),
      completedLocations,
    };
  }
  ...
  addFriend(
    userId: string,
    friendUsername: string,
  ): { success: boolean; message: string; friend?: Friend } {
    ...
    const existingFriendship = friends.find(
      (f) => f.userId === userId && f.friendId === friendUser.id,
    );
